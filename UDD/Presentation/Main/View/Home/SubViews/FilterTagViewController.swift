...
class FilterTagViewController: UIViewController, UIViewControllerTransitioningDelegate {
    ...
    override func viewDidLoad() {
        ...
        dogSizeHashTag.topAnchor.constraint(
        ...
        dogHashTagLabel.topAnchor.constraint(
        ...
        distanceSlider.topAnchor.constraint(
        ...
        bottomBorderLine.topAnchor.constraint(
...
//         ).isActive = true
    ...
    var dogSizeHashTag: TTGTextTagCollectionView =  {
        let tagView: TTGTextTagCollectionView = TTGTextTagCollectionView(
            frame: CGRect(
                x: 28,
                y: 200,
